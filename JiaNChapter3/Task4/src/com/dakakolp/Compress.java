...
public class Compress {
    ...
    public static void zipDirectory(String dir, String zipfile) throws IOException {
        File d = new File(dir);
        if(!d.isDirectory())
            throw new IllegalArgumentException("Compress: is not directory: " + dir);
    ...
    public static class Test {
        public static void main(String[] args) throws IOException {
            if((args.length != 1) || (args.length != 2)) {
                System.err.println("Format: java Compress$Test <from> [<to>]");
                System.exit(0);
            }
            ...
            if((new File(to)).exists()) {
                System.err.println("Compress: cannot overwrite existing files" );
                System.exit(0);
            }
